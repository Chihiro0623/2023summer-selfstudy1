...
class ResNeXtBottleNeck(nn.Module):
    ...
    def __init__(self, in_planes, group_width, cardinality, stride=1):
        ...
        self.conv2 = nn.Conv2d(group_width, group_width, kernel_size=3, stride=1, padding=1, groups=cardinality,
                               bias=False)
...
class ResNeXt(nn.Module):
    def __init__(self, block, num_blocks, cardinality=32, width=4, num_classes=100):
