...
setting_dict = dict(
    ...
    cifar100kd="data --dataset_type CIFAR100 --train-size 32 32 --random-crop-pad 4 --test-size 32 32 --mean 0.5 0.5 0.5 --std 0.5 0.5 0.5 --epoch 200 --optimizer sgd --nesterov --lr .5 --min-lr 5e-5 --weight-decay 1e-4 --warmup-epoch 5 --scheduler cosine -b 256 -j 2 --pin-memory --amp --channels-last -tm seresnext50_32_4 --criterion kd",
)
