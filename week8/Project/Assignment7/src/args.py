...
def get_args_parser():
    ...
    # analysis-data
    parser.add_argument('--data-dir', type=str, default='/home/oso0310/private/data/imageNet', help='dataset dir')
    ...
    parser.add_argument('--n-class', type=int, default=1000, help='number of class')
