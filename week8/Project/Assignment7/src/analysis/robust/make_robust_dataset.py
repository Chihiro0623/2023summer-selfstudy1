...
class DistortImageFolder(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        save_path = os.path.join("/home/oso0310/private/project7","distort", self.method.__name__, str(self.severity),
...
def save_distorted(method, root):
    """
    :param method: Distort method
    :param root: Your validation dataset path
    """
...
def generate_corrupted_images(root):
    for method_name in d.keys():
        save_distorted(d[method_name], root=root)

if __name__ == '__main__':
    root = '/home/oso0310/private/project7/imageNet/train/'
    save_distorted(d['Brightness'], root=root)