...
def get_args_parser():
    ...
    parser.add_argument('--img-path', type=str, default='src/data/sample_images/cat.jpg', help='single image path')
    parser.add_argument('--img-label', type=int, default=45, help='single image label')
    parser.add_argument('--pca-data-dir', type=str, default='src/data/harryported_giffins', help='image dir for PCA')
    parser.add_argument('--n-class', type=int, default=100, nargs='+', help='number of class')
